...
export default function Home() {
  return (
    <>
      <main className="grid min-h-screen overflow-hidden bg-black text-white md:grid-cols-3 pt-32 pb-20 md:pt-0 md:pb-6">
        <MainIntro />
        <MainPanel />
      </main>
    </>
...
function MainPanel() {
  return (
    <section className="relative mt-10 md:mt-0 z-10 mx-5 lg:col-span-2 lg:flex lg:items-center lg:justify-center">
      <div className="grid gap-y-3 mt-4 lg:mt-0 lg:grid-cols-3 lg:gap-x-4 lg:gap-y-4 relative">
        <IntroCard />
        <TwitterCard />
        <svg
          ...
          height={200}
          fill="none"
          className="w-auto h-full absolute left-0 top-2 z-0"
...
function IntroCard() {
  return (
    <div
      className="w-full relative z-10 rounded-2xl border-8 border-white/10 px-10 py-10 md:col-span-2 md:px-20 md:py-20 backdrop-blur-lg"
      style={{
...
function TwitterCard() {
  return (
    <Link
      ...
      target="_blank"
      className="group flex h-auto w-full flex-col rounded-2xl border-2 border-gray-400 bg-[#8ecdf8] px-4 py-4 md:w-52"
    >
      <svg
