...
function LanguagesCard() {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="relative z-10 w-full overflow-hidden rounded-3xl bg-gradient-to-tr from-[#dce35b] via-[#45b649] via-30% to-[#dce35b] px-10 py-10 lg:col-span-2 lg:px-6 lg:py-10">
