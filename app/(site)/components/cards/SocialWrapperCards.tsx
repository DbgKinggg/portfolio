...
function SocialWrapperCards() {
    return (
        <div className="lg:col-span-2 grid grid-cols-2 gap-x-1 lg:gap-y-2">
            <TwitterCard />
            <ContactCard />
        </div>
    );
...
function TwitterCard() {
    return (
        ...
        >
            <svg
                className="w-10 h-10 lg:h-14 lg:w-14 transition group-hover:scale-105"
            ...
            <label className="mt-8 cursor-pointer text-lg lg:text-2xl text-gray-900 md:mt-auto">
                @Dbgkinggg
            </label>
        </Link>
    )
...
function ContactCard() {
    return (
        <div
            className="group flex h-auto w-full flex-col rounded-3xl border-2 border-gray-800 bg-[#171a22]/90 px-4 py-4 lg:col-span-2"
        >
            <div className="flex space-x-2 items-center">
                <Link
                    ...
                    target="_blank"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-10 h-10 lg:w-14 lg:h-14">
                ...
                <Link
                    href="mailto:samuelyimingchen@gmail.com"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        data-name="Layer 1"
            ...
            <label className="mt-8 text-lg lg:text-2xl text-gray-300 md:mt-auto">
                Contact Me
            </label>
        </div>
    );
