...
function TwitterToolsCard() {
  return (
    <div className="relative z-10 min-h-[200px] w-full rounded-3xl bg-[#808df8] px-10 py-10 lg:col-span-2 lg:px-10 lg:py-10">
      <h3 className="text-3xl font-bold text-gray-50">Twitter Tools</h3>
      <a
