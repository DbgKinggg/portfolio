...
function MainIntro() {
    return (
        <section className="relative flex flex-col items-center justify-center max-h-screen">
            ...
            <div className="absolute left-0 z-0 h-72 w-screen -translate-x-[65%] scale-150 rounded-full bg-[#7c79bf] max-h-96 lg:max-h-none md:h-screen md:-translate-x-[99%] lg:fixed lg:top-1/2 lg:-translate-y-1/2"></div>
        </section>
    )
}
